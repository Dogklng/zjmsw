...
//const SDK_SIGN_CERT_PATH = '/data/www/mally/unionchargepay/certs/yinlian312.pfx';
//const SDK_SIGN_CERT_PATH='/data/www/mally/unionchargepay/certs/PM_700000000000001_acp.pfx';
define('SDK_SIGN_CERT_PATH',SDK_ROOT.'/unionchargepay/certs/meishu2017.pfx');
// 签名证书密码
//const SDK_SIGN_CERT_PWD = '312';		//
define('SDK_SIGN_CERT_PWD','069190');

// 密码加密证书（这条用不到的请随便配）verify_sign_acp
//const SDK_ENCRYPT_CERT_PATH = '/data/www/mally/unionchargepay/certs/312cer.cer';
//define('SDK_ENCRYPT_CERT_PATH',SDK_ROOT.'/unionchargepay/certs/312cer.cer');

// 验签证书路径（请配到文件夹，不要配到具体文件）
//const SDK_VERIFY_CERT_DIR = '/data/www/mally/unionchargepay/certs/';
define('SDK_VERIFY_CERT_DIR',SDK_ROOT.'/unionchargepay/certs/');
...
// 前台通知地址 (商户自行配置通知地址)
//const SDK_FRONT_NOTIFY_URL = 'http://m.eshopaux.com/unionchargepay/FrontReceive.php';
define('SDK_FRONT_NOTIFY_URL','http://'.$_SERVER['HTTP_HOST'].'/unionchargepay/FrontReceive.php');
// 后台通知地址 (商户自行配置通知地址)
//const SDK_BACK_NOTIFY_URL = 'http://m.eshopaux.com/unionchargepay/BackReceive.php';
define('SDK_BACK_NOTIFY_URL','http://'.$_SERVER['HTTP_HOST'].'/unionchargepay/BackReceive.php');

//文件下载目录 
//const SDK_FILE_DOWN_PATH = '/data/www/mally/unionchargepay/file/';
define('SDK_FILE_DOWN_PATH',SDK_ROOT.'/unionchargepay/file/');

//日志 目录 
//const SDK_LOG_FILE_PATH = '/data/www/mally/unionchargepay/logs/';
define('SDK_LOG_FILE_PATH',SDK_ROOT.'/unionchargepay/logs/');
