//定义数组，存储省份信息
var province = ["北京市", "上海市", "天津市", "重庆市", "浙江省", "江苏省", "广东省", "福建省", "湖南省", "湖北省", "辽宁省",
    "吉林省", "黑龙江省", "河北省", "河南省", "山东省", "陕西省", "甘肃省", "新疆维吾尔自治区", "青海省", "山西省", "四川省",
    "贵州省", "安徽省", "江西省", "云南省", "内蒙古自治区", "西藏自治区", "广西壮族自治区", "宁夏回族自治区", "海南省", "香港特别行政区", "澳门特别行政区", "台湾省"];
