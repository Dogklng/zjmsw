                ...
                function n(n) {
                    function i() {
                        for (var n, d, f = 0; f < r.length;)
                            if (n = r[f], d = n.parentNode, d && /svg/i.test(d.nodeName)) {
                                var h = n.getAttribute("xlink:href");
                                if (o) {
                                    var m = new Image,
                                        p = d.getAttribute("width"),
                                        g = d.getAttribute("height");
                                    m.src = a(h, d, n), p && m.setAttribute("width", p), g && m.setAttribute("height", g), d.replaceChild(m, n)
                                } else if (s && (!c || c(h, d, n))) {
                                    var v = h.split("#"),
                                        w = v[0],
                                        y = v[1];
                                    if (d.removeChild(n), w.length) {
                                        ...
                                        b.s || (b.s = [], b.open("GET", w), b.send()), b.s.push([d, y]), t(b)
                    ...
                    var o, r = document.getElementsByTagName("use"),
                        a = n.fallback || function (e) {
                            return e.replace(/\?[^#]+/, "").replace("#", ".").replace(/^\./, "") + ".png" + (/\?[^#]+/.exec(e) || [""])[0]
                        };
                    o = "nosvg" in n ? n.nosvg : /\bMSIE [1-8]\b/.test(navigator.userAgent), o && (document.createElement("svg"), document.createElement("use"));
    ...
    3: [
        function (e, t, n) {
            ...
            $(document).ready(function () {
                ...
                c.FastClick.attach(document.body), b.run()
            }), t.exports = n["default"]
        }, {
                    ...
                    return o(e, [{
                        ...
                        value: function () {
                            ...
                            function t(n) {
								...
								$(".dl-welcome").addClass("anim-out"), $(".dl-mainLogo").addClass("anim-in"), window.setTimeout(e, 2e3)
                            ...
                            $(".dl-welcome_center").addClass("anim-in"), $(".dl-welcome_quote").addClass("anim-in"), $(".dl-welcome_message").addClass("anim-in"), r.loader.once("complete", function () {
                                $(".dl-welcome_bottom").addClass("anim-in"), $(".dl-welcome_counter").addClass("anim-in"), $(".dl-welcome_loader_container").addClass("anim-out"), window.setTimeout(function () {
                                    t(3)
                                }, 500)
                            })
                        }
                    ...
                    return o(e, [{
                        ...
                        value: function () {
                            if (void 0 != window.devicePixelRatio)
                                if (-1 != navigator.userAgent.indexOf("Safari") && -1 == navigator.userAgent.indexOf("Chrome")) var e = 1;
                            ...
                            f.scale(2, 2);
                            var h = new Image;
                            h.src = "/Public/Home/Images/logo-header.png";
                            var m = !1;
                            h.onload = function () {
                                m = !0
                            };
                            var p, g, v, w, y, b, k, C, E, T, _, x, I, S, P, M = ["/Public/Home/Images/first_illustration.jpg"],
                                j = ["/Public/Home/Images/first_illustration_small.jpg"],
                                L = 0;
//                               if(flag == false){
//                               	p, g, v, w, y, b, k, C, E, T, _, x, I, S, P, M = null;
//                               }
                            p = function () {
                                function u(u) {
                                    var d, f, h, m;
                                    this.options = null != u ? u : {}, this.defaults = {
                                        offsetRotation: 0,
                                        offsetScale: 1,
                                        offsetX: 0,
                                        offsetY: 0,
                                    ...
                                    for (d in f) m = f[d], this[d] = m;
                                    h = this.options;
                                    for (d in h) m = h[d], this[d] = m;
                                    null == this.renderer && (this.renderer = PIXI.autoDetectRenderer(c, l, {
                                        antialias: !0,
                                        backgroundColor: 1087931,
                                        preserveDrawingBuffer: !0 //CANVAS 宽高
                                    }), Modernizr.cssvhunit && Modernizr.cssvwunit ? (this.renderer.view.style.width = "90vw", this.renderer.view.style.height = "95vh") : (this.renderer.view.style.width = "90%", this.renderer.view.style.height = "90%"), this.renderer.view.style.position = "absolute", this.renderer.view.style.left = "5%", this.renderer.view.style.top = "5%", s.md.mobile() || (this.renderer.resolution = e), document.body.appendChild(this.renderer.view), this.renderer.resize(c, l)), null == this.stage && (this.stage = new PIXI.Container, this.container = new PIXI.Container, this.arc = [], this.sprite = [], this.piece = []);
                                    var p = this;
                                  	 
									 function changeit() {
                                        s.md.mobile() || s.md.phone() || s.md.tablet() ? (p.image = PIXI.Texture.fromImage("/Public/Home/Images/first_illustration_small.jpg"), r.ticker.add(function () {
                                            if (t = r.ticker.deltaTime, o += .09, i) {
                                                var e = (i.getScreenAdjustedQuaternion(), i.getScreenAdjustedMatrix(), i.getScreenAdjustedEuler());
                                                w.offsetX += (6 * e.beta - w.offsetX) * w.easeMobile + o, w.offsetY += (6 * e.gamma - w.offsetY) * w.easeMobile * t, w.offsetRotation += (.02 * e.alpha - w.offsetRotation) * w.easeMobile * t
                                            }
                                            w.draw()
                                        })) : (p.image = PIXI.Texture.fromImage("/Public/Home/Images/first_illustration.jpg"), r.ticker.add(function () {
                                            o += .03, t = r.ticker.deltaTime, n = r.ticker.elapsedMS;
                                            var e;
                                            e = Math.atan2(Math.sin(T), Math.cos(T)), w.offsetX += (_ - w.offsetX) * w.ease + o, w.offsetY += (x - w.offsetY) * w.ease, w.offsetRotation += (.25 * e - w.offsetRotation) * w.ease, w.draw()
                                        })), p.init()
//                                      
                                        
                                    }
                                    a.loader.once("complete",changeit);
                                     
                                    
                                }
                                return u.prototype.HALF_PI = Math.PI / 2, u.prototype.TWO_PI = 2 * Math.PI, u.prototype.init = function () {
                                    for (this.piece = [], this.sprite = [], this.arc = [], this.container = new PIXI.Container, this.stage.removeChildren(), S = g = 0, E = this.slices; E >= 0 ? E >= g : g >= E; S = E >= 0 ? ++g : --g) P = this.TWO_PI / this.slices, this.piece.push(new PIXI.Container), this.arc.push(new PIXI.Graphics), this.sprite.push(new PIXI.extras.TilingSprite(this.image, 3 * c, 3 * c)), this.piece[g].addChild(this.arc[g]), this.piece[g].addChild(this.sprite[g]), this.container.addChild(this.piece[g]), this.arc[g].moveTo(this.radiusX, this.radiusY), this.arc[g].beginFill(0), this.arc[g].arc(this.radiusX, this.radiusY, 10 * this.radiusX, P * -.51, .51 * P), this.piece[g].pivot.x = this.radiusX, this.piece[g].pivot.y = this.radiusY, this.piece[g].rotation = S * P, this.sprite[g].mask = this.arc[g], this.sprite[g].tileScale.y = [1, -1][S % 2], s.md.phone() && (this.sprite[g].tileScale.y = [.5, -.5][S % 2], this.sprite[g].tileScale.x = .5), this.sprite[g].position.y = l / 2 - this.image.height / 2;
                                    this.container.position.x = this.radiusX, this.container.position.y = this.radiusY, this.stage.addChild(this.container), this.draw()
                                }, u.prototype.draw = function () {
                                    var e, t, n, i, o, r, a;
                                    for (this.renderer.render(this.stage), r = this.zoom * (this.radius / Math.min(c, l)), a = this.TWO_PI / this.slices, e = this.image.width / 2, o = [], n = t = 0, i = this.slices; i >= 0 ? i >= t : t >= i; n = i >= 0 ? ++t : --t) this.sprite[t].tilePosition.x = this.offsetX, this.sprite[t].tilePosition.y = [-1 * this.offsetY, this.offsetY][n % 2];
                                    return this.container.rotation = this.offsetRotation, o
                                }, u
                            }(), w = new p({
                                image: v,
                                slices: 16,
                                ease: .075,
                                easeMobile: .2
                            }), _ = w.offsetX, x = w.offsetY, T = w.offsetRotation, I = w.zoom, y = function (e) {
                                return function (e) {
                                    var t, n, i, o;
                                    return t = e.pageX / c, n = e.pageY / l, i = t - .5, o = n - .5, _ = i * w.radius * -2, x = o * w.radius * 2, T = Math.atan2(o, i)
                                }
                            }(this), k = function (e) {
                                return function (e) {
                                    c = $(window).width(), l = $(window).height(), w.radius = c / 2, w.radiusX = c / 2, w.radiusY = l / 2, w.renderer.resize(c, l), w.container.position.x = w.radiusX, w.container.position.y = w.radiusY
                                }
                            }(this), b = function (e) {
                                return function (e) {
                            ...
                            }, $(window).keydown(C), window.addEventListener("resize", k, !1), window.addEventListener("mousemove", y, !1);
                            var X = document.getElementById("clickHack");
                            X.addEventListener("click", b, !1)
                            setInterval(function(){
                            	$("#clickHack").trigger("click");
                            },8000)
                        }
                    }]), e
                }();
    ...
    7: [
        function (e, t, n) {
            ...
            function i() {
                o.md.mobile() ? (a.add("second_illustration", "/Public/Home/Images/second_illustration_small.jpg"), a.add("third_illustration", "/Public/Home/Images/third_illustration_small.jpg")) : (a.add("second_illustration", "/Public/Home/Images/second_illustration.jpg"), a.add("third_illustration", "/Public/Home/Images/third_illustration.jpg")), a.load(), a.once("complete", function () {
                    n.secondLoaded = s = !0
                })
            }
            Object.defineProperty(n, "__esModule", {
            ...
            var s = !1;
            n.secondLoaded = s, o.md.mobile() ? r.add("first_illustration", "/Public/Home/Images/first_illustration_small.jpg") : r.add("first_illustration", "/Public/Home/Images/first_illustration.jpg"), r.load(), r.once("complete", i)
        }, {
            "./mobileDetect": 8
        }
    ],
                    ...
                    return o(e, [{
                        ...
                        value: function () {
                            ...
                            e.mobile() || e.phone() || e.tablet() ? $(".js-share_open").on("click", function () {
                                $(".dl-svg_share").toggleClass("is-visible"), $(".dl-svg_close").toggleClass("is-visible"), $(".js-share_list").toggleClass("is-active")
                            }) : $(".js-footer_item-share").addClass("no-mobile"), e.phone() || $(".dl-share_item-whatsapp").remove()
                        }
                    }]), e
                }();
            n["default"] = r, t.exports = n["default"]
