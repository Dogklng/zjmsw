...
(function(q) {
	Galleria.addTheme({
		...
		init: function(b) {
			...
			b._showProgress && this.bind("progress",
			function(a) {
			...
			h.click(function() {
				...
				},
				{
					...
					complete: function() {
						...
						h[d ? "removeClass": "addClass"]("open");
						d = !d
					}
				})
			});
			b._showPopout ? k.click(function(b) {
				a.openLightbox();
				b.preventDefault()
			}) : (k.remove(), b._showFullscreen && (this.$("s4").remove(), this.$("info").css("right", 40), f.css("right", 0)));
			j.click(function() {
				a.defineTooltip("play", g ? c.play: c.pause);
				g ? a.pause() : (d && h.click(), a.play())
			});
			b._showFullscreen ? f.click(function() {
				m ? a.exitFullscreen() : a.enterFullscreen()
			}) : (f.remove(), b._show_popout && (this.$("s4").remove(), this.$("info").css("right", 40), k.css("right", 0))); ! b._showFullscreen && !b._showPopout && (this.$("s3,s4").remove(), this.$("info").css("right", 10));
