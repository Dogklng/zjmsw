...
//                                      
    ...
    7: [
        function (e, t, n) {
            ...
            function i() {
                o.md.mobile() ? (a.add("second_illustration", "./images/second_illustration_small.jpg"), a.add("third_illustration", "./images/third_illustration_small.jpg")) : (a.add("second_illustration", "./images/second_illustration.jpg"), a.add("third_illustration", "./images/third_illustration.jpg")), a.load(), a.once("complete", function () {
                    n.secondLoaded = s = !0
                })
            }
            Object.defineProperty(n, "__esModule", {
            ...
            var s = !1;
            n.secondLoaded = s, o.md.mobile() ? r.add("first_illustration", "./images/first_illustration_small.jpg") : r.add("first_illustration", "./images/first_illustration.jpg"), r.load(), r.once("complete", i)
        }, {
            "./mobileDetect": 8
        }
    ],
