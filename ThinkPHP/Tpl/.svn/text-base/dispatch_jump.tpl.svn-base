<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <style type="text/css">
    *{ padding: 0; margin: 0; }
    body{ background: #fff; font-family: '微软雅黑'; color: #333; font-size: 18px; }
    .message{width: 400px;height: 180px;margin:auto;border:1px solid #1B8F24;margin-top: 30px;}
    ...
    <body>
    <div class="message">
    <div class="head"><span>美术网 提示您:</span></div>
    <div class="content">
