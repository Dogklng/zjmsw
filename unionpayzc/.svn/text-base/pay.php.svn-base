...
include_once $_SERVER ['DOCUMENT_ROOT'] . '/unionpayzc/func/SDKConfig.php';
include_once $_SERVER ['DOCUMENT_ROOT'] . '/unionpayzc/func/secureUtil.php';
include_once $_SERVER ['DOCUMENT_ROOT'] . '/unionpayzc/func/log.class.php';
...
if($header=='YU'){
    ...
    $query=$db->query("select * from `app_order_crowd` where order_no='$order_no'");
}
