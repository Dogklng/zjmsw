...
define('SDK_SIGN_CERT_PATH',SDK_ROOT.'/unionpayzc/certs/meishu2017.pfx');
// 签名证书密码
...
define('SDK_VERIFY_CERT_DIR',SDK_ROOT.'/unionpayzc/certs/');
...
define('SDK_FRONT_NOTIFY_URL','http://'.$_SERVER['HTTP_HOST'].'/unionpayzc/FrontReceive.php');
// 后台通知地址 (商户自行配置通知地址)
//const SDK_BACK_NOTIFY_URL = 'http://m.eshopaux.com/unionpay/BackReceive.php';
define('SDK_BACK_NOTIFY_URL','http://'.$_SERVER['HTTP_HOST'].'/unionpayzc/BackReceive.php');

//文件下载目录 
//const SDK_FILE_DOWN_PATH = '/data/www/mally/unionpay/file/';
define('SDK_FILE_DOWN_PATH',SDK_ROOT.'/unionpayzc/file/');

//日志 目录 
//const SDK_LOG_FILE_PATH = '/data/www/mally/unionpay/logs/';
define('SDK_LOG_FILE_PATH',SDK_ROOT.'/unionpayzc/logs/');
