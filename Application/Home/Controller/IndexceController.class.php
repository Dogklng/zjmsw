...
class IndexceController extends BaseController
{
    ...
    public function index()
    {
        ...
        $res1 = M('goods')->where(array('is_del'=>0,'is_sale'=>1,'store'=>1,'cstore'=>0,'is_groom'=>1,'activity_id'=>0))->order('sort desc,id desc')->limit(6)->select();
        foreach($res1 as $k=>$v){
