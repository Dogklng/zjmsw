...
//dump($res1);exit;
    ...
    protected  function alipay_config($style = '')
    {
		if($style == 'baoding'){
			...
			$returnUrl = "http://" . $_SERVER['HTTP_HOST'] . "/Home/Pm/ReturnBURL";
			$notufyUrl = "http://" . $_SERVER['HTTP_HOST'] . "/Home/Pm/NotifyBURl";
		}else if($style == 'ruzhu'){
			$returnUrl = "http://" . $_SERVER['HTTP_HOST'] . "/Home/Pm/ReturnRURL";
			$notufyUrl = "http://" . $_SERVER['HTTP_HOST'] . "/Home/Pm/NotifyRURl";
		}else if($style == 'pm'){
			$returnUrl = "http://" . $_SERVER['HTTP_HOST'] . "/Home/Pm/ReturnPURL";
			$notufyUrl = "http://" . $_SERVER['HTTP_HOST'] . "/Home/Pm/NotifyPURl";
		}else if($style == 'libao'){
            $returnUrl = "http://" . $_SERVER['HTTP_HOST'] . "/Home/Index/ReturnLURL";
