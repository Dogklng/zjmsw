...
return array(
    ...
    'TMPL_PARSE_STRING'  =>array(
    	...
    	'__C_JS__' => '/Public/Common/Js',
    	'__PLUGJS__' => '/Public/Admin/Js/layer',
        '__CSS__' => '/Public/Admin/Css',
    	'__PLUGCSS__' => '/Public/Admin/Css',
    	...
    	'__PUBLIC__' => '/Public',
        '__UM__' => '/Public/Admin/um',
        '__LAYDATE__' => '/Public/Admin/laydate',
        '__JEDATE__'    => '/Public/Admin/Jedate',
    ),
