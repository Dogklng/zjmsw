...
//dump($res1);exit;
    ...
    protected  function alipay_config($style = '')
    {
		if($style == 'baoding'){
			...
			$returnUrl = "https://" . $_SERVER['HTTP_HOST'] . "/Wxin/Pm/ReturnBURL";
			$notufyUrl = "https://" . $_SERVER['HTTP_HOST'] . "/Home/Pm/NotifyBURl";
		}else if($style == 'ruzhu'){
			$returnUrl = "https://" . $_SERVER['HTTP_HOST'] . "/Wxin/Pm/ReturnRURL";
			$notufyUrl = "https://" . $_SERVER['HTTP_HOST'] . "/Home/Pm/NotifyRURl";
		}else if($style == 'pm'){
			$returnUrl = "https://" . $_SERVER['HTTP_HOST'] . "/Wxin/Pm/ReturnPURL";
			$notufyUrl = "https://" . $_SERVER['HTTP_HOST'] . "/Home/Pm/NotifyPURl";
		}else if($style == 'libao'){
            $returnUrl = "https://" . $_SERVER['HTTP_HOST'] . "/Wxin/Index/ReturnLURL";
